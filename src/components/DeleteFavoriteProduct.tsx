...
const DeleteFavoriteProduct = ({removeProductToTheWishList, id}: DeleteProductProps) => {
  return (
    <>
      <S.DeleteFavoriteProduct__Container>
          <CiCircleRemove className="product__icon_delete" onClick={() => removeProductToTheWishList(id)}/>
        </S.DeleteFavoriteProduct__Container>
    </>
  );
};
